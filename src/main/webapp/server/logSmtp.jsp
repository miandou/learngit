        ...
        <td height="24" bgcolor="#353c44"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td><div align="right"><span class="STYLE1">
			  ...
			  <a href="${pageContext.request.contextPath}/Log/deleteAllSmtp" onclick="return confirmAct();" target="rightFrame"><img src="${pageContext.request.contextPath}/user/images/add.gif" width="10" height="10" /><span style="color:white"> 删除全部</span>   &nbsp;</a> </span><span class="STYLE1"> &nbsp;</span></div></td>
          </tr>
        </table></td>
      </tr>
    </table></td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" onmouseover="changeto()"  onmouseout="changeback()">
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><a href="${pageContext.request.contextPath}/Log/deleteSmtp?delid=<%=l.getId() %>&currentpage=<%=since_id%>" onclick="return confirmAct();">删除</a>
    </div></td>
          </tr>
      <%}} %>
     </table></td>
    ...
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="67%"><table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td width="49"><div align="center"><a href="${pageContext.request.contextPath}/Log/firstSmtppage?since_id=<%=since_id%>"><img src="${pageContext.request.contextPath}/user/images/main_54.gif" width="40" height="15" /></a></div></td>
            <%if(since_idd>1){ %>
            <td width="49"><div align="center"><a href="${pageContext.request.contextPath}/Log/previousSmtppage?since_id=<%=since_id%>"><img src="${pageContext.request.contextPath}/user/images/main_56.gif" width="45" height="15" /></a></div></td>
            <%} %>
            <%if(since_idd<pagesum){ %>
            <td width="49"><div align="center"><a href="${pageContext.request.contextPath}/Log/nextSmtppage?since_id=<%=since_id%>"><img src="${pageContext.request.contextPath}/user/images/main_58.gif" width="45" height="15" /></a></div></td>
            <%} %>
            <td width="49"><div align="center"><a href="${pageContext.request.contextPath}/Log/lastSmtppage?since_id=<%=since_id%>"><img src="${pageContext.request.contextPath}/user/images/main_60.gif" width="40" height="15" /></a></div></td>
